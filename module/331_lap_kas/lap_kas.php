...
<head>
	...
	<!-- Call Custom Library -->
	<script src="../module/331_lap_kas/lap_kas.js" type="text/javascript"></script>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div class='input-group date' id="datetimepicker1">
                                        <input type='text' class="form-control" id="dari" size="20" />
                                ...
                                <td>
                                    ...
                                    <div class='input-group date' id="datetimepicker2">
                                        <input type='text' class="form-control" id="sampai" size="20" />
                                        <span class="input-group-addon">
                                            <span class="glyphicon glyphicon-calendar"></span>
                                        </span>
                                    </div>
                                ...
                                <td>
                                    <br>
                                    <a>
                                        <button class="btn" id="load_kas_harian">Load</button>
                                    </a>
                                </td>
                        </table>
                        </fieldset>
                            ...
                            <tr>
                                <td>
                                    <label>Periode</label><br>
                                        ...
                                        data-show-subtext="true" data-live-search="true" 
                                        name="periode_kas" id="periode_kas">
                                    </select>
                                </td>
                                <td>&nbsp;</td>
                                <td>
                                ...
                                <td>
                                    <br>
                                    <a>
                                        <button class="btn" id="load_kas_periode">Load</button>
                                    </a>
                                </td>
                            </tr>
                        </table>
