...
<head>
    ...
    <!-- Call Custom Library -->
    <script src="../module/225_setoran_zisr/print_zisr.js" type="text/javascript"></script>
<body>
<?php
                    ...
                    <table width="100%" border="0" class="table table-bordered table-condensed">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td align="right" id="total_penerimaan"><b></b></td>
                            </tr>
                        </tfoot>
                    </table>
                    <table width="100%" border="0" class="table table-bordered table-condensed">
                        ...
                        <tfoot>
                            <tr>
                                <td align='right'><b>Total: </b></td>
                                <td align="right" id="total_penerimaan_nt"><b></b></td>
                            </tr>
                        </tfoot>
                    </table>
                    <table width="100%">
