...
<head>
	...
	<!-- Call Custom Library -->
	<script src="../module/232_lap_transaksi/lap_transaksi.js" type="text/javascript"></script>
        ...
        <!-- fieldset -->
            ...
            <div class="form-group">
                ...
                <div class="row" id="header">
                    ...
                    <div class="col-md-4">
                        <fieldset>
                        <legend>Mutasi Bank</legend>
                        <table border="0" cellspacing="2" cellpadding="2">
                            <tr>
                                <td>
                                    <label>Dari</label><br>
                                    <div class='input-group date' id="dtbank1">
                                        <input type='text' class="form-control" id="dari_bank" size="25" />
                                        <span class="input-group-addon">
                                            <span class="glyphicon glyphicon-calendar"></span>
                                        </span>
                                    </div>
                                ...
                                <td>
                                    <label>Sampai</label><br>
                                    <div class='input-group date' id="dtbank2">
                                        <input type='text' class="form-control" id="sampai_bank" size="25" />
                                        <span class="input-group-addon">
                                            <span class="glyphicon glyphicon-calendar"></span>
                                        </span>
                                    </div>
                                ...
                                <td>
                                    <br>
                                    <a>
                                        <button class="btn" id="load_penerimaan_bank">Load</button>
                                    </a>
                                </td>
                            </tr>
                        </table>
