...
<head>
	...
	<!-- Call Custom Library -->
	<script src="../module/221_donasi/donasi.js" type="text/javascript"></script>
...
<body>
	    ...
	    <div class="modal-dialog" style="width:800px">
	        <div class="modal-content">
	            <div class="modal-header">
                    ...
                    <!-- <button type="button" class="btn btn-success" id="new_donatur" data-dismiss="modal">Tambah Donatur</button> -->
	            </div>
	...
	<div class="container-fluid">
        <fieldset>
			<legend>TRANSAKASI ZAKAT INFAQ DAN SODAQOH</legend>
