$(document).ready(function() {
    ...
    $(function () {
        ...
        table = $('#tabelbatal').DataTable( {
            "ajax": urlAPI+"/app/module/non_tunai/get_donasi.php",
    ...
    function cetak(){
		...
		$.ajax({
			url:  urlAPI+"/app/module/non_tunai/donasi_save.php",
			type: 'POST',
			dataType: 'json',
			data: {
				aksi:'save',
			...
			success : function(data){
                alert(data.pesan);
                $('.konten').load('222_non_tunai/struk_donasi.php','no_donasi='+data.no_donasi);
			}, 
			error: function(data){
				alert(data.pesan);
			}
    ...
    function reprint(){
        ...
        $('.konten').load('222_non_tunai/struk_donasi.php','no_donasi='+no_donasi);
    }

    function batalDonasi(){
		var no_donasi = $('#no_donasi').val();
		$.ajax({
			url:  urlAPI+"/app/module/non_tunai/donasi_reject.php",
			type: 'POST',
			dataType: 'json',
			data: {
				'aksi':'reject',
