...
<head>
	...
	<!-- Call Custom Library -->
	<script src="../module/113_kat_asset/kat_asset.js" type="text/javascript"></script>
</head>
<body>
	<br>
	...
	<div class="container-fluid">
		<div class="row-fluid clearfix">
			...
			<fieldset>
				...
				<!-- <form class="form" id="frmanggota" action="" method="post"> -->
					<div class="form-group">
						...
						<div class="row">
							<div class="col-md-4">
								<input type="text" class="col-md-2 form-control" id="kode_kat_asset"
								placeholder="Kode Kategori" readonly="true">
							</div>
							<div class="col-md-8">
								<input type="text" class="col-md-6 form-control" id="kategori" 
			...
			<div class="col-md-7 column">
				<table id="tabelkatasset" class="display" cellspacing="0">
					<thead>
						<tr>
							<th>Kode</th>
