...
<head>
	...
	<!-- Call Custom Library -->
	<script src="../module/632_buku_besar/buku_besar.js" type="text/javascript"></script>
                        ...
                        <legend>Per Akun</legend>
                            ...
                            <tr>
                                ...
                                <td>
                                    <br>
                                    <a>
                                        <button class="btn" id="load_bb">Load</button>
                                    </a>
                                </td>
                            </tr>
                            </table>
                        ...
                        <legend>Per Periode</legend>
                            ...
                            <tr>
                                ...
                                <td>
                                    <br>
                                    <a>
                                        <button class="btn" id="load_all_bb">Load</button>
                                    </a>
                                </td>
                            </tr>
                            </table>
