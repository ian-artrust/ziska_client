...
<head>
	...
	<!-- Call Custom Library -->
	<script src="../module/433_lap_mustahik/lap_mustahik.js" type="text/javascript"></script>
        ...
        <!-- fieldset -->
            ...
            <div class="form-group">
                ...
                <div class="row" id="header">
                    ...
                    <div class="col-md-6">
                        <fieldset>
                        <legend>Pendistribusian Mustahik</legend>
                    ...
                    <div class="col-md-6">
                        <fieldset>
                        <legend>Data Mustahik</legend>
                            <br>
                            <button class="btn" id="load_mustahik">Daftar Mustahik</button>
                            &nbsp;
                            <button class="btn" id="load_mustahik_entitas">Daftar Mustahik Entitas</button>
                        </fieldset>
                    </div>
                </div>
                <br>
