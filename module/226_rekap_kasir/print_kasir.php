...
<head>
    ...
    <!-- Call Custom Library -->
    <script src="../module/226_rekap_kasir/print_kasir.js" type="text/javascript"></script>
<body>
<?php
...
<div id="cetak">
    ...
    <div class="row col-md-8">
        <table width="100%">
            <tr>
                <td>
                    <b>REKAP PENERIMAAN HARIAN</b>
                    <input type="hidden" id="tgl_donasi" value="<?php echo $tgl_donasi; ?>">
                </td>
                <td>
                    <b>
                    <input type="text" size="2" class="form-control" name="A2" id="A2" value="Formulir A2">
                    </b>
                </td>
            </tr>
        </table>
