...
<head>
	...
	<!-- Call Custom Library -->
	<script src="../module/111_user/user.js" type="text/javascript"></script>
</head>
<body>
	<br>
	...
	<div class="container-fluid">
		<div class="row-fluid clearfix">
					...
					<div class="form-group">
						...
						<div class="row">
				            ...
				            <select class="form-control" name="level" id="level">
								...
								<option value="AW">Admin Wilayah</option>
		                ...
		                <div class="row">
		                    <div class="col-md-4">
		                        <input type="text" class="form-control" name="kode_daerah" 
								id="kode_daerah" placeholder="Kode" readonly="" />		                    </div>
		                    <div class="col-md-6">
		                        <input type="text" class="form-control" name="nama_daerah" 
								id="nama_daerah" placeholder="Nama Daerah" readonly="" />
		                    </div>
		                    <div class="col-md-1">
		                        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#daerahModal">
			...
			<div class="col-md-7 column">
				<table id="tabeluser" class="display" cellspacing="0">
					<thead>
						<tr>
							<th>Kode</th>
							<th>Nama Admin</th>
	...
	<!-- Modal Lookup Kantor -->
	<div class="modal fade" id="daerahModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	    <div class="modal-dialog" style="width:800px">
	        <div class="modal-content">
	            <div class="modal-header">
	                ...
	                <h4 class="modal-title" id="myModalLabel">Lookup Data Daerah</h4>
	            </div>
	            <div class="modal-body">
	                <table id="lookup_daerah" width="100%" class="table table-bordered table-hover table-striped">
	                    <thead>
	                        <tr>
	                            <th>Kode Daerah</th>
	                            <th>Nama Daerah</th>
