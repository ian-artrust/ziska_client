...
<head>
   ...
   <script src="../bower_components/jquery/dist/jquery.min.js" type="text/javascript"></script>
	...
	<!-- Call Custom Library -->
	<script src="../module/631_jurnal/jurnal.js" type="text/javascript"></script>
	...
	<div class="container-fluid">
        <div class="row col-md-12">
            <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#tab_ju">JURNAL UMUM</a></li>
                <li><a data-toggle="tab" href="#tab_jp">PENYESUAIAN</a></li>
            </ul>

            <div class="tab-content">
                <br>
                <div id="tab_ju" class="tab-pane fade in active">
                    <div class="row container-fluid">
                        <table border="0" cellspacing="2" cellpadding="2">
                            <tr>
                                <td>
                                    <label>Periode JU</label><br>
                                        <select class="form-control" style="width:125px;" 
                                        data-show-subtext="true" data-live-search="true" 
                                        name="periode_ju" id="periode_ju">
                                    </select>
                                </td>
                                <td>&nbsp;</td>
                                <td>
                                    <br>
                                    <a>
                                        <button class="btn" id="load_ju">Load</button>
                                    </a>
                                </td>
                            </tr>
                        </table>
                ...
                <div id="tab_jp"  class="tab-pane">
                    <div class="row container-fluid">
                        <table border="0" cellspacing="2" cellpadding="2">
                            <tr>
                                <td>
                                    <label>Periode JP</label><br>
                                        <select class="form-control" style="width:125px;" 
                                        data-show-subtext="true" data-live-search="true" 
                                        name="periode_jp" id="periode_jp">
                                    </select>
                                </td>
                                <td>&nbsp;</td>
                                <td>
                                    <br>
                                    <a>
                                        <button class="btn" id="load_jp">Load</button>
                                    </a>
                                </td>
                            </tr>
                        </table>
