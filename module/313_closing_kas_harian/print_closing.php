...
<head>
    ...
    <!-- Call Custom Library -->
    <script src="../module/313_closing_kas_harian/print_closing.js" type="text/javascript"></script>
<body>
<?php
...
<div id="cetak">
    ...
    <div class="row col-md-8">
        <table width="100%">
            <tr>
                <td>
                    <b>REKAP KAS PENERIMAAN</b>
                    <input type="hidden" id="tgl_donasi" value="<?php echo $tgl_donasi; ?>">
                </td>
                <td>
                    <b>
                    <input type="text" size="2" class="form-control" name="A2" id="A2" value="Formulir A3">
                    </b>
                </td>
            </tr>
        </table>
            ...
            <tr>
                <td id="kiri" valign="top">
                    ...
                    <table width="100%" border="0" class="table table-bordered table-condensed">
                        ...
                        <tbody id="data-here-nt"></tbody>
                        <tfoot>
                            <tr>
                                <td>Total Penerimaan: </td>
                                <td align="right"><span id="total_penerimaan_nt"></span></td>
                            </tr>
                        </tfoot>
                    </table>
                    <table width="100%">
                        <tr align="center">
                            <td></td>
                            <td align="right"><?php echo $daerah.", ".date('d F Y', strtotime($tgl_donasi)); ?></td>
                        </tr>
                        <tr align="center">
                            <td>Keuangan</td>
                            <td>Direktur</td>
                        ...
                        <tr>
                            <td id="kasir" align="center" contenteditable="true">---</td>
                            <td align="center" contenteditable="true">Sabar Waluyo, SE</td>
                        </tr>
                    </table>
                ...
                <td id="kanan">
                    <table width="50%" class="table table-bordered table-condensed" id="denominasi">
                        <tr>
                            <td colspan='2'>DENOMINASI TUNAI</td>
                        </tr>
                        <tr>
